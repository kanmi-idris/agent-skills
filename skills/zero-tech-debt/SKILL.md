---
name: zero-tech-debt
description: Rework a change as if the intended UX and architecture existed from day one, deleting compatibility cruft and accidental complexity. Use this whenever the user wants a refactor that should optimize for the final product shape instead of preserving historical patch structure, asks to remove compatibility layers, mode flags, wrappers, aliases, dead fallbacks, or wants a feature rewritten from the intended end state with minimal accidental complexity.
---
