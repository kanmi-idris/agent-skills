...
- `react-native-hidden-styles` — guidance for lesser-known and newer React Native styling techniques such as gradients, `boxShadow`, `filter`, `gap`, and `mixBlendMode`.
...
- `react-19-reference` — consolidated React 19 reference guidance covering hooks, RSC boundaries, compiler config, directives, performance tracks, and core React rules.
- `app-qa-audit` — end-to-end QA guidance for Android APKs, mobile builds, and live webapps, with optional Maestro E2E automation and API/security inspection.
